  ...
  Widget build(BuildContext context) {
    return Column(   
      children: <Widget>[                 
        ...
        RaisedButton(
          shape: StadiumBorder(),
          onPressed: _phoneController.text.isNotEmpty ? _onSubmittedPhoneNumber : null,
...
class _PhoneVerifyCode extends State<PhoneVerifyCode> {
  ...
  void _onResendPhoneNumber() {
    BlocProvider.of<UserActionBloc>(context).add(SelectUserRole(role: 'NumberPhoneSignIn'));
    _codeController.text = '';
  }
